...
/* package EvtConverterHaskell-0.1.0.0 */
#ifndef VERSION_EvtConverterHaskell
#define VERSION_EvtConverterHaskell "0.1.0.0"
#endif /* VERSION_EvtConverterHaskell */
#ifndef MIN_VERSION_EvtConverterHaskell
#define MIN_VERSION_EvtConverterHaskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_EvtConverterHaskell */
...
#define CURRENT_COMPONENT_ID "EvtConverterHaskell-0.1.0.0-718qAdeOKXqEWx0By4MIY7-EvtConverterHaskell"
